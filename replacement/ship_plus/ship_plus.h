#ifndef REPLACEMENT__PLUS_H
#define REPLACEMENT_SHIP_PLUS_H
...
struct ship_plus : public champsim::modules::replacement {
private:
  int& get_rrpv(long set, long way);
  int& get_block_hit(long set, long way);
